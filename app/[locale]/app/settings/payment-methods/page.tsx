...
export default async function PaymentMethodsSettingsPage({
  ...
  const t = await getTranslations('app.settings.paymentMethods');
  const tForm = await getTranslations('app.form');

  const business = await getCurrentBusiness();
  const methods = business ? await listPaymentMethodOptions(business.id) : [];
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mt-8">
        <TaxonomyManager
          ...
          renameAction={renamePaymentMethodAction}
